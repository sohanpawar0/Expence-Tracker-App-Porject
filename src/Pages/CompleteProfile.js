...
const CompleteProfile = () => {
  ...
  const updateHandler = (e) => {
    ...
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyC3bRHiJj9MDtKyAtFMzxfWuFftjdJSGW0",
      {
        method: "POST",
        body: JSON.stringify({
          idToken: id,
    ...
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyC3bRHiJj9MDtKyAtFMzxfWuFftjdJSGW0", 
      {
        method: "POST",
        body: JSON.stringify({
          idToken: id,
